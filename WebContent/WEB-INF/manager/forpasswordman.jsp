            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <strong class="">Change Password</strong>
     			...
     			lowercase character,one uppercase character and special symbol(@#$%)
                	...
                	<form method="post" action="forpassword" role="form" id="form1" class="form-horizontal">
                        <div class="form-group">
                            <label for="id" class="col-sm-4 control-label">Manager Id</label>
                        ...
                        <div class="text-center">
   							<button type="button" class="btn btn-success" onclick="go('forpassword')">Reset</button>
   							<button type="button" class="btn btn-success" onclick="go('passwordbackman')">Back</button>
  						</div>
  </form>
            </div></div></div>
