    ...
    implements SessionAware
{
    ...
    static Logger log = Logger.getLogger( adminpassword.class );

    final static private String PASSCHANGEBACK = "adminpasswordback";
    ...
    public String adminpasswordback()
    {

        return PASSCHANGEBACK;
    }
